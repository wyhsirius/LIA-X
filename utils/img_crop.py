...
def compute_bbox(bbox, frame_shape, increase_area=0.1):
    ...
    top = int(top - height_increase * height * 1.5)
...
def crop(frame, w, h, left, top):
    ...
    #img_crop = frame[top:top + h, left:left + w]
    size = min(h, w)
...
if __name__ == '__main__':
    ...
    #data_dir = args.path #"/mnt/petrelfs/wangyaohui/projects/LIA-X/data/raw/"#ghibli-2.png"
    save_path = './data/source/' + Path(args.data_path).stem + "_crop.png" #"/mnt/petrelfs/wangyaohui/projects/LIA-X/data/source/"
